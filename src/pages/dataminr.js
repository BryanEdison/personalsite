...
class Dataminr extends React.Component {
  ...
  render() {
    ...
    <Nav sticky={this.state.stickyNav} />
      ...
      <header className="major">
            ...
            <p>I'm sincerely interested in working for Dataminr ever since first reading about Dataminr in the Technology section of the New York Times. As someone who studied economics and is deeply interested in how external variables influence behavior, one of my interests is in studying the role of social media in everyday life.</p>
            <p>I love working with your front-end tech stack and have completed several fullstack projects using both React and React-Native. I graduated from Fullstack 6 months ago and I am currently a Software Engineer at SploreGuide, a tourism marketplace startup. I'm currently working on building out their Web and Mobile apps using React, React-Native, MongoDB, Apollo-Express, and GraphQL.
            </p>
            <p>Prior to programming, I graduated from Binghamton University with a double degree in Economics and Sociology, and a minor in Chinese Studies. After attempting to innovate ride-sharing among college students with a web app in college, I became hooked into world of software development.
            </p>
            <p>As a Software engineering intern, I will be able to use my education and work experience to help build out new features, develop tests, and provide innovative solutions within the engineering team at Dataminr.
            </p>
        </div>
