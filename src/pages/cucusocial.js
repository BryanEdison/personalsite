...
class Cucusocial extends React.Component {
  ...
  render() {
    ...
    <Nav sticky={this.state.stickyNav} />
      ...
      <header className="major">
            ...
            <p>I'm sincerely interested in working for you. I saw an open position for both front-end and fullstack software engineer and I am interested in applying to both. I love working with your tech stack and have completed several fullstack projects using them. Interestingly, I first came across Cucusocial on EventBrite when planning an event and recognized you upon seeing the AngelList jobs posting.</p>
