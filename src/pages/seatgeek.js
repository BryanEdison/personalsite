...
class SeatGeek extends React.Component {
  ...
  render() {
    ...
    <Nav sticky={this.state.stickyNav} />
      ...
      <header className="major">
            ...
            <p>I'm sincerely interested in working for SeatGeek since using their platform for personal tickets. After gaining interest in SeatGeek, I contacted Charlie DiGiovanna, a former colleague from Binghamton University and a software Engineer currently working there, to inquire more about SeatGeek. After hearing back, I knew that SeatGeek would be a great fit for me. I saw an open position for front-end software engineer and immediately decided to reach out and apply. I love working with your tech stack and have completed several fullstack projects using them. </p>
