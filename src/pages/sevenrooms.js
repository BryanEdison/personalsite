...
class SevenRooms extends React.Component {
  ...
  render() {
    ...
    <Nav sticky={this.state.stickyNav} />
      ...
      <header className="major">
            ...
            <p>As a Software engineer at SevenRooms, I will be able to use my education and work experience to develop tests and provide front-end and back-end support, while actively contributing towards the engineering team’s development.
            </p>
        </div>
