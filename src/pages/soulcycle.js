...
class SoulCycle extends React.Component {
  ...
  render() {
    ...
    <Nav sticky={this.state.stickyNav} />
      ...
      <header className="major">
            ...
            <p>I'm sincerely interested in working for SoulCycle since hearing about the company culture from an old colleague. As someone who is into fitness and interested in increasing my cardiovascular endurance, I admire SoulCycle's mission</p>
            <p>I saw an open position for a software engineer and  immediately decided to reach out and apply. I love working with your tech stack and have completed several fullstack projects using them. I graduated from Fullstack 5 months ago and I am currently a Software Engineer at SploreGuide, a tourism marketplace startup. I'm currently working on building out their Web and Mobile apps using React, React-Native, MongoDB, Apollo-Express, and GraphQL.
            </p>
