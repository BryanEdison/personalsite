...
class RGA extends React.Component {
  ...
  render() {
    ...
    <Nav sticky={this.state.stickyNav} />
      ...
      <header className="major">
            ...
            <p>I'm sincerely interested in working for R/GA since hearing about the company culture from an old colleague. As someone who studied economics and is deeply interested in how external variables influence consumer behavior, I naturally became interested in the front-end engineer position that R/GA had.</p>
            <p>I love working with your tech stack and have completed several fullstack projects using them. I graduated from Fullstack 5 months ago and I am currently a Software Engineer at SploreGuide, a tourism marketplace startup. I'm currently working on building out their Web and Mobile apps using React, React-Native, MongoDB, Apollo-Express, and GraphQL.
            </p>
            ...
            <p>As a Software engineer at R/GA, I will be able to use my education and work experience to develop tests and provide front-end and back-end support, while actively contributing towards the engineering team’s development.
            </p>
        </div>
